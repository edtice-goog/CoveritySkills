...
def nested_components(name):
    """`_ZN9Collector9DIRECTIONE` -> ('Collector',
...
class Printer:
    ...
    def _build(self, t, inner):
        ...
        if tag == "array_type_t":
            ...
            # A flexible array member (`unsigned char body[];`) carries the
...
class Slice:
    ...
    # it. `char name[24];` and `static const char tag[4] = "ab";` both
    ...
    def name_anonymous(self, body):
        ...
        (`static constexpr char const [16] = "drive";`) and every use
