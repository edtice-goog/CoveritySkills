...
def render(issue, src, strip, context):
    ...
    L.append("## Verdict")
    L.append("")
    L.append("_Fill in: `real` | `real-but-arguable` | `false positive`, and why._")
    L.append("")
    L.append("Real-but-arguable is a demo failure too: a finding that needs")
    L.append("minutes of code reading, or an invariant the audience cannot see,")
    L.append("should not be the defect on screen.")
    L.append("")
